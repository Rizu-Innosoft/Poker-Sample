...
export const getAgentsListAction = (data) => {
  return postRequest("getAgentsList", data).then((res) => {
    return res.data;
  });
};
...
export const addtournamentAction = (data) => {
  return postRequest("addtournament", data).then((res) => {
    return res.data;
  });
};

export const getpokertableAction = (data) => {
  return postRequest("getpokertable", data).then((res) => {
    return res.data;
  });
};

export const addpokertableAction = (data) => {
  return postRequest("addpokertable", data).then((res) => {
    return res.data;
  });
};

export const updatepokertableAction = (data) => {
  return postRequest("updatepokertable", data).then((res) => {
    return res.data;
  });
};

export const updatetournamentAction = (data) => {
  return postRequest("updatetournament", data).then((res) => {
    return res.data;
  });
};
