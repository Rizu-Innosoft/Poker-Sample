                                            ...
                                            <div className='row'>
                                                ...
                                                <div className='col-md-6'>
                                                    ...
                                                    <div class="form-group row mb-1">
                                                        ...
                                                        <div class="col-md-12">
                                                            <Input class="form-control" type="password" pattern="^(?=.*\d)(?=.*[a-zA-Z]).{8,}$"
                                                                ...
                                                                onPaste={(e) => {
                                                                    ...
                                                                    e.preventDefault()
                                                                    return false;
                                                                }} name="newPassword" value={form.newPassword} placeholder="Enter new password" onChange={inputHandler} />
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <Input class="form-control" type="password" pattern="^(?=.*\d)(?=.*[a-zA-Z]).{8,}$"
                                                                ...
                                                                onPaste={(e) => {
                                                                    ...
                                                                    e.preventDefault()
                                                                    return false;
                                                                }} name="confirmPassword" value={form.confirmPassword} placeholder="Enter confirm password" onChange={inputHandler} />
                                                        </div>
                                                    </div>

                                                    <div className='text-center'>
                                                        <button type="submit" onClick={SubmitForm} className='btn btn-primary changebtn'>Change Password</button>
                                                    </div>
